...
const (
	Ingest_Push_FullMethodName = "/ingest.Ingest/Push"
)
...
func (c *ingestClient) Push(ctx context.Context, in *PushRequest, opts ...grpc.CallOption) (*PushReply, error) {
...
func (UnimplementedIngestServer) Push(context.Context, *PushRequest) (*PushReply, error) {
...
func _Ingest_Push_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IngestServer).Push(ctx, req.(*PushRequest))
	}
