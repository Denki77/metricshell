...
Пройдено 23/23. Для каждого in-container shape выполнено 10 iterations. 100 concurrent publications оставили ровно 100
...
достаточны для research, для SLO нужно 30+. Docker/curl overhead включён. Только Linux inotify.
