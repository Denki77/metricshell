...
1. Process and PID 1 model
2. Workload lifecycle and exit semantics
3. Shutdown time budgeting
4. Metric-state ownership and semantics
5. Ingestion transport comparison
6. File-based ingestion
7. Socket-based ingestion
8. Local push ingestion
9. Shared-memory and mmap feasibility
10. Prometheus exposition
11. Final-state and scrape-count semantics
12. Kubernetes Job/CronJob viability
13. Distribution models
14. Security and resource limits
15. Benchmarks and final comparison
...
|---------|-------------------------|-------------|----------|----------|
| INV-001 | PID 1 and process model | Not started | —        | —        |
| INV-002 | Workload lifecycle      | Not started | —        | —        |
| INV-003 | Shutdown budgeting      | Not started | —        | —        |
| INV-004 | Metric-state semantics  | Not started | —        | —        |
| INV-005 | Transport comparison    | Not started | —        | —        |
| INV-006 | File ingestion          | Not started | —        | —        |
| INV-007 | Socket ingestion        | Not started | —        | —        |
| INV-008 | Local push              | Not started | —        | —        |
| INV-009 | Shared memory/mmap      | Not started | —        | —        |
| INV-010 | Exposition              | Not started | —        | —        |
| INV-011 | Final scrape semantics  | Not started | —        | —        |
| INV-012 | Kubernetes viability    | Not started | —        | —        |
| INV-013 | Distribution            | Not started | —        | —        |
| INV-014 | Security and limits     | Not started | —        | —        |
| INV-015 | Benchmarks              | Not started | —        | —        |
