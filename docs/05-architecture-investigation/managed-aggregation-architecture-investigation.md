...
| INV-019 | [Performance and Resource Limits](managed-aggregation-architecture-research.md#inv-019)       | In progress | `research/INV-019/` | ADR-019 / benchmark and limit specification  |
