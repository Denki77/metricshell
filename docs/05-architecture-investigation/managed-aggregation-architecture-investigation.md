...
| INV-017 | [Concurrent Publishers and Ordering](managed-aggregation-architecture-research.md#inv-017)    | In progress | `research/INV-017/` | ADR-017 or specification update              |
