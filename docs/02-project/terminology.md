...
| Snapshot        | One complete application metric state used as the atomic ingestion and exposition unit.                                                                                                                                                               |
| Final Snapshot  | Frozen last valid accepted complete application snapshot after workload completion.                                                                                                                                                                   |
